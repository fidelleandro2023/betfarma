...
class AuthCrud extends Command
{
    ...
    public function handle(){ 
        ...
        $data_to_write .= '    <title>Laravel Spatie Permission</title>'.PHP_EOL;
        ...
        $data_to_write .= '                <a class="navbar-brand" href="{{ url(\'/\') }}">'.PHP_EOL;
        $data_to_write .= '                    Laravel Spatie Tutorial'.PHP_EOL;
